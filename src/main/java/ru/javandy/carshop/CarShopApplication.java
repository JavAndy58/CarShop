...
public class CarShopApplication {
    ...
    @Bean
    public CommandLineRunner dataDetailLoader(DetailService detailService, CarService carService,
                                              OrderService orderService, CustomerRepository customerRepository) throws ParseException {
