...
public class CarShopApplication {
    ...
    public CommandLineRunner dataDetailLoader(DetailService detailService, CustomerService customerService,
        ...
        return args -> {
            ...
            customerService.save(new Customer("Иван Петров", "+79273893138"));
            customerService.save(new Customer("Ершое Евгений", "+72273893138"));
            customerService.save(new Customer("Макаров Владимир", "+75553893138"));

            carService.save(new Car("Focus 2", "XXEERTY525SA626", customerService.findById(2)));
            carService.save(new Car("Logan 1", "TTTYYY525SA626", customerService.findById(2)));
            carService.save(new Car("Audi 100", "YUTYRYREYRA626", customerService.findById(1)));
